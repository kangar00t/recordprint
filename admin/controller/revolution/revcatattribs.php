...
class ControllerRevolutionRevcatattribs extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('revolution/revcatattribs', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			$this->response->redirect($this->url->link('revolution/revcatattribs', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('revolution/revcatattribs', 'user_token=' . $this->session->data['user_token'], 'SSL')
		);
