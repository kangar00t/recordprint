...
class ControllerRevolutionRevpopupphone extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('revolution/revpopupphone', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	public function edit_status() {
		...
		if ($this->validateForm()) {
			$this->model_revolution_revpopupphone->editPhoneStatus($this->request->get['pphone_id']);
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('revolution/revpopupphone', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('revolution/revpopupphone/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('revolution/revpopupphone/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['reviews'][] = array(
				...
				'edit'       => $this->url->link('revolution/revpopupphone/edit', 'user_token=' . $this->session->data['user_token'] . '&pphone_id=' . $result['pphone_id'] . $url, 'SSL'),
				'edit_status' => $this->url->link('revolution/revpopupphone/edit_status', 'user_token=' . $this->session->data['user_token'] . '&pphone_id=' . $result['pphone_id'] . $url, 'SSL')
			);
		}
		...
		$pagination->url = $this->url->link('revolution/revpopupphone', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['pphone_id'])) {
			$data['action'] = $this->url->link('revolution/revpopupphone/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('revolution/revpopupphone/edit', 'user_token=' . $this->session->data['user_token'] . '&pphone_id=' . $this->request->get['pphone_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('revolution/revpopupphone', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
