...
class ControllerRevolutionRevblogsetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('revolution/revblog_setting', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('revolution/revblog_setting', 'user_token=' . $this->session->data['user_token'], 'SSL')
		);

		$data['action'] = $this->url->link('revolution/revblog_setting', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		if (isset($this->request->post['revblog_settings'])) {
			...
			$data['revblog'] = array(
				...
				'category_blog_grid' 		=> true,
				'blog_date_status' 			=> true,
				'related_left_status' 		=> false
			);
		}
