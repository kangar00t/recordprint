...
class ControllerRevolutionRevtextblocks extends Controller {
	...
	public function add(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('revolution/revtextblocks', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('revolution/revtextblocks', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('revolution/revtextblocks/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('revolution/revtextblocks/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['textblockss'][] = array(
				...
				'edit'            => $this->url->link('revolution/revtextblocks/edit', 'user_token=' . $this->session->data['user_token'] . '&tb_id=' . $result['tb_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('revolution/revtextblocks', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('revolution/revtextblocks', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('revolution/revtextblocks', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['tb_id'])) {
			$data['action'] = $this->url->link('revolution/revtextblocks/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('revolution/revtextblocks/edit', 'user_token=' . $this->session->data['user_token'] . '&tb_id=' . $this->request->get['tb_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('revolution/revtextblocks', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
