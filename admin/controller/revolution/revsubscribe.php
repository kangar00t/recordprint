...
class ControllerRevolutionRevsubscribe extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('revolution/revsubscribe', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('revolution/revsubscribe', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('revolution/revsubscribe/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('revolution/revsubscribe/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['reviews'][] = array(
				...
				'edit'       => $this->url->link('revolution/revsubscribe/edit', 'user_token=' . $this->session->data['user_token'] . '&subscribe_id=' . $result['subscribe_id'] . $url, 'SSL')
			);
		}
		...
		$pagination->url = $this->url->link('revolution/revsubscribe', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['subscribe_id'])) {
			$data['action'] = $this->url->link('revolution/revsubscribe/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('revolution/revsubscribe/edit', 'user_token=' . $this->session->data['user_token'] . '&subscribe_id=' . $this->request->get['subscribe_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('revolution/revsubscribe', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
